      ...
      <div className="grid lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div className="space-y-6 text-brand-muted text-lg leading-relaxed">
            ...
            <p>
We focus exclusively on the landscaping industry because we know what works. We don't guess. We deploy proven frameworks to generate quotes, not just clicks.
            </p>
